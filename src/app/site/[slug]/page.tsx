      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-30 text-center px-4 max-w-5xl pt-20">
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2 mb-8 animate-fade-in-up">
            ...
            <span className="text-sm text-white/90">Expert Clinical Care</span>
          </div>

          <h1 className="text-3xl md:text-6xl lg:text-7xl font-extrabold tracking-tight text-white mb-8">
            Recover Faster at <br />
            <span className="bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400 bg-clip-text text-transparent">
              {org.name}
            </span>
          </h1>
          <p className="text-xl md:text-2xl text-white/80 max-w-3xl mx-auto mb-10">
            Professional physiotherapy, rehabilitation, and wellness services. Book your assessment online.
          </p>
         ...
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 md:mb-20">
              <h2 className="text-2xl md:text-5xl font-bold text-gray-900 mb-6">
                Simple <br />
                <span className="bg-gradient-to-r from-blue-500 to-indigo-500 bg-clip-text text-transparent">Patient Journey</span>
              </h2>
              <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
                Start your tailored treatment plan in just a few clicks.
              </p>
            </div>
            ...
            <div className="relative max-w-5xl mx-auto">
               ...
               <div className="relative flex items-center mb-12 md:mb-20">
                  ...
                  <div className="ml-24 md:ml-0 md:w-1/2 md:pr-16 md:text-right">
                     <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-2 md:mb-3">1. Select Treatment</h3>
                     <p className="text-gray-600 leading-relaxed text-sm md:text-base">
                        Choose &apos;Initial Assessment&apos; if you are new, or follow-up sessions.
                     </p>
                  </div>
               </div>
               ...
               <div className="relative flex items-center mb-12 md:mb-20 justify-end md:justify-start">
                  ...
                  <div className="ml-24 md:ml-auto md:w-1/2 md:pl-16 text-left">
                     ...
                     <p className="text-gray-600 leading-relaxed text-sm md:text-base">
                        Pick a convenient slot with your preferred physiotherapist.
                     </p>
                  </div>
               </div>
               ...
               <div className="relative flex items-center mb-12 md:mb-20">
                  ...
                  <div className="ml-24 md:ml-0 md:w-1/2 md:pr-16 md:text-right">
                     <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-2 md:mb-3">3. Patient Details</h3>
                     <p className="text-gray-600 leading-relaxed text-sm md:text-base">
                        Fill in your info to create your confidential patient file.
                     </p>
                  </div>
               </div>
               ...
               <div className="relative flex items-center justify-end md:justify-start">
                  ...
                  <div className="ml-24 md:ml-auto md:w-1/2 md:pl-16 text-left">
                     <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-2 md:mb-3">4. Confirm & Visit</h3>
                     <p className="text-gray-600 leading-relaxed text-sm md:text-base">
                        Secure your booking and start your recovery.
                     </p>
                  </div>
               </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We provide evidence-based treatment plans tailored to your specific injury or condition.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
            ...
            <div className="group bg-white p-8 rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 hover:shadow-2xl hover:shadow-indigo-500/10 transition-all duration-500 hover:-translate-y-1 text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Expert Therapists</h3>
              <p className="text-gray-600 leading-relaxed">
                Qualified professionals dedicated to your rehabilitation and long-term health.
              </p>
            </div>
            ...
            <div className="group bg-white p-8 rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 hover:shadow-2xl hover:shadow-blue-500/10 transition-all duration-500 hover:-translate-y-1 text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Modern Facility</h3>
              <p className="text-gray-600 leading-relaxed">
                Equipped with the latest rehabilitation technology in a calming environment.
              </p>
            </div>
            ...
            <div className="group bg-white p-8 rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 hover:shadow-2xl hover:shadow-violet-500/10 transition-all duration-500 hover:-translate-y-1 text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Convenient Booking</h3>
              <p className="text-gray-600 leading-relaxed">
                No waiting on hold. View live availability and book your session instantly.
              </p>
            </div>
