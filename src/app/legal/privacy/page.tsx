export default function PrivacyPolicy() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 md:py-20 prose prose-slate text-gray-900">
      <h1 className="text-gray-900"> <b>Privacy Policy</b></h1>
      ...
      <br />
      <h2 className="text-gray-900"><b>1. Information We Collect</b></h2>
      <p>
      ...
      <br />
      <h2 className="text-gray-900"><b>2. How We Use Your Information</b></h2>
      <p>
      ...
      <br />  
      <h2 className="text-gray-900"><b>3. Data Security</b></h2>
      <p>
